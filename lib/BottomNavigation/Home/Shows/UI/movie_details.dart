...
class MovieDetailsPage extends StatelessWidget {
  ...
  MovieDetailsPage({this.title, this.genre, this.image});

  @override
  Widget build(BuildContext context) {
    return MovieDetailsBody(title, genre, image);
  }
}
...
class MovieDetailsBody extends StatefulWidget {
  ...
  MovieDetailsBody(this.title, this.genre, this.image);
                      ...
                      Container(
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage(
                                widget.image ?? 'images/movie poster.png'),
                            fit: BoxFit.cover,
                          ),
                        ),
